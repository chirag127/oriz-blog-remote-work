# Remote Work — `oriz-blog-remote-work`

> Work from anywhere, done right — async, tooling, and the remote-team playbook.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-remote-work?style=flat)](https://github.com/chirag127/oriz-blog-remote-work/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-remote-work)](https://github.com/chirag127/oriz-blog-remote-work/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-remote-work/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-remote-work/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Remote Work** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
A remote-work blog on async collaboration, home-office tooling, and distributed-team practices that actually scale.

- **Live site:** https://remote-work-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-remote-work
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-remote-work/ — the canonical, always-current site is **https://remote-work-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-remote-work/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>remote-work-blog.oriz.in"]
...
```
oriz-blog-remote-work/
├── src/
│   ├── content/blog/       # the remote-work guides (MDX/Markdown)
